...
void printLongWord(uint32_t word) {
    transmitByte('0' + (word / 1000000000));          /* Billions */
    transmitByte('0' + ((word / 100000000) % 10));    /* Hundred-millions */
    transmitByte('0' + ((word / 10000000) % 10));     /* Ten-millions */
    transmitByte('0' + ((word / 1000000) % 10));      /* Millions */
    transmitByte('0' + ((word / 100000) % 10));       /* Hundred-thousands */
